...
const StudentManagement = () => {
  ...
  const handleToggleStatus = async (student) => {
    ...
    try {
      await axios.put(`http://localhost:8000/api/students/${student._id}/update/`, { status: updatedStatus, role: userRole });
  ...
  const handleSaveChanges = async () => {
    try {
      ...
      await axios.put(`http://localhost:8000/api/students/${editableStudent._id}/update/`, payload);
